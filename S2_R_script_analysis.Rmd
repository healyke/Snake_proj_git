...
prey_mean <- (log10(as.numeric(as.character(mydat.P$prey_mass))) -
                mean(log10(as.numeric(as.character(mydat.P$prey_mass)))))
              /sd(log10(as.numeric(as.character(mydat.P$prey_mass))))

prey_max <- (log10(as.numeric(as.character(mydat.P$prey_max))) -
               mean(log10(as.numeric(as.character(mydat.P$prey_max)))))
              /sd(log10(as.numeric(as.character(mydat.P$prey_max))))
